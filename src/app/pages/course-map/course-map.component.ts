...
export class CourseMapComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //   this.course = course;
    //   this.course.points.map((point) => { point['active'] = false; return point;  });
      // this.initMap();
      // this.addPins();
    // });
    // this.initMap()
  ...
  private initMap(): void {
    ...
    mapboxgl.accessToken = 'pk.eyJ1Ijoib2tmZGUiLCJhIjoiY2lpOHhvMnNhMDAyNnZla280ZWhmMm96NyJ9.IvGz74dvvukg19B4Npsm1g';
    this.map = new mapboxgl.Map({
      container: 'mymap', // container id
      style: 'mapbox://styles/okfde/cjdpsmil20u672snqyxkrgjiv', // stylesheet location
      center: [13.390, 52.518], // starting position [lng, lat]
  ...
  private addPins() {
    ...
    for (let pin of this.course.points) {
